...
/// @nodoc
abstract class _$$SchooldayImplCopyWith<$Res>
    implements $SchooldayCopyWith<$Res> {
  factory _$$SchooldayImplCopyWith(
          _$SchooldayImpl value, $Res Function(_$SchooldayImpl) then) =
      __$$SchooldayImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({DateTime schoolday});
}
...
/// @nodoc
class __$$SchooldayImplCopyWithImpl<$Res>
    extends _$SchooldayCopyWithImpl<$Res, _$SchooldayImpl>
    implements _$$SchooldayImplCopyWith<$Res> {
  __$$SchooldayImplCopyWithImpl(
      _$SchooldayImpl _value, $Res Function(_$SchooldayImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$SchooldayImpl implements _Schoolday {
  _$SchooldayImpl({required this.schoolday});

  factory _$SchooldayImpl.fromJson(Map<String, dynamic> json) =>
      _$$SchooldayImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SchooldayImplCopyWith<_$SchooldayImpl> get copyWith =>
      __$$SchooldayImplCopyWithImpl<_$SchooldayImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SchooldayImplToJson(
      this,
    );
  }
}
...
abstract class _Schoolday implements Schoolday {
  factory _Schoolday({required final DateTime schoolday}) = _$SchooldayImpl;

  factory _Schoolday.fromJson(Map<String, dynamic> json) =
      _$SchooldayImpl.fromJson;
